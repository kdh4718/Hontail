...
public class CommentController {
    ...
    public ResponseEntity<List<CommentDto>> getCocktailComments(@PathVariable Integer cocktailId) {
    ...
    public ResponseEntity<CommentDto> addComment(@PathVariable Integer cocktailId, @RequestBody CommentDto commentDto) {
    ...
    public ResponseEntity<?> updateComment(@PathVariable Integer cocktailId, @PathVariable Integer commentId, @RequestBody CommentDto commentDto) {
    ...
    public ResponseEntity<?> deleteComment(@PathVariable Integer cocktailId, @PathVariable Integer commentId) {
        commentService.deleteComment(cocktailId, commentId);
